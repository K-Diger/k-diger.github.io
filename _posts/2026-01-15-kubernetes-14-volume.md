---
layout: post
title: "Kubernetes 가이드 - Volume, PV, PVC 이해"
date: 2026-01-15
...
- [Kubernetes 가이드 - 스케줄링](/kubernetes/kubernetes-15-scheduling)
- [Kubernetes 가이드 - 리소스 관리](/kubernetes/kubernetes-16-resource-management)
